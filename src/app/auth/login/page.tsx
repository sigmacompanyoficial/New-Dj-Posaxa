...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-6">
      ...
      >
        <h2 className="text-3xl font-black uppercase text-center mb-8">Iniciar Sessió</h2>
        ...
        <div className="relative my-8 text-center">
          ...
          <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#050505] px-4 text-[10px] text-gray-600 font-bold uppercase tracking-[3px]">O</span>
        </div>

        <button 
          onClick={handleGoogleLogin}
          className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 text-white font-bold uppercase tracking-widest py-4 rounded-xl hover:bg-white/10 transition-colors"
        >
        ...
        <p className="text-center text-gray-500 mt-6 text-sm">
          No tens compte? <Link href="/auth/register" className="text-white hover:underline">Registra't aquí</Link>
        </p>
      </motion.div>
    </div>
  );
